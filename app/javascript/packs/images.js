...
const images = [
  {nameId: 'bread-grind', content: logo1},
  {nameId: 'ham-and-eggs', content: logo2},
  {nameId: 'italian', content: logo3},
  {nameId: 'japanese-food', content: logo4},
  {nameId: 'mxdowells', content: logo5},
  {nameId: 'pops', content: logo6},
];
